...
import { View, Text, StyleSheet, Image, TouchableOpacity, ScrollView, Platform, Linking, Alert, useWindowDimensions } from 'react-native';
import { ArrowLeft, Star, MapPin, Phone, MessageSquare, ShieldCheck, Heart, CheckCircle2, Share } from 'lucide-react-native';
...
export default function ShopDetailsScreen({ route, navigation }: any) {
  ...
  const ContactCard = () => (
    <View style={styles.contactCard}>
      ...
      {/* @ts-ignore */}
      <TouchableOpacity style={[styles.btnPrimary, { cursor: Platform.OS === 'web' ? 'pointer' : 'auto' }]} onPress={handleCall}>
        <Phone color="#FFFFFF" size={20} style={styles.btnIcon} />
        <Text style={styles.btnPrimaryText}>Secure Proxy Call</Text>
      </TouchableOpacity>
