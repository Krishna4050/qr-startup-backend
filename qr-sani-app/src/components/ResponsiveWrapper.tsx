...
//   return (
//     <View style={[styles.webBackground, { backgroundColor: bg }]}>
...
//   webContainer: {
//     width: '100%',
//     maxWidth: 480, // Constrains it to a nice "mobile-pro" width on desktop. You can increase this to 800 or 1200 for a wider dashboard!
//     height: '100%',
//     maxHeight: 900,
